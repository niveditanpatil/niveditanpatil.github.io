...
- How do teams share what they learn about these tools?
- What about security and governance? (this is a big one)
- Does this actually make me more productive, or is it just hype?

## Who Might Find This Useful?

If you work with data and Databricks—whether you're a data engineer, data scientist, ML engineer, or analytics engineer—and you're curious about these AI coding tools, then we're probably in the same boat. I'm figuring this out as I go, so expect plenty of "here's what worked" and "here's what definitely didn't work."
...
My next post will probably be about why I think data folks should at least try these AI tools (spoiler: I'm still forming my opinion). After that, I'll share how I got my development environment set up—including all the stuff that went wrong the first time.
